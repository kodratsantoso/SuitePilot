  ...
  return (
    <div>
      <PageHeader
        ...
        description="Configure AI agents, skill defaults, and workspace preferences"
      />
      <div className="mt-8 rounded-lg border border-dashed border-gray-300 bg-gray-50 px-6 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-gray-500 max-w-sm mx-auto">
          AI workspace settings — including agent configuration, default skill parameters,
          model preferences, and review workflow rules — will be available in a future release.
        </p>
      </div>
    </div>
  )
